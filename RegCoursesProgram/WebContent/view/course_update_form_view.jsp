...
<div id="wrap">
		...
		<section>
			...
			<table border="1" id= "formtb">
				...
				<tr>
					<th>시작시간</th>
					<td><input type="text" name="start_hour" maxlength="4" value=${course.start_hour }></td>
				</tr>
				<tr>
					<th>종료시간</th>
					<td><input type="text" name="end_hour" maxlength="4" value=${course.end_hour }></td>
				</tr>		
			</table>
			<table id="buts2">
				<tr><td>
